...
require("lazy").setup({
	...
	{
		dir = "~/personal/projects/scratch-buffer-nvim/",
		name = "scratch-buffer",
		config = function()
			local scratch_buffer = require("scratch-buffer")
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>sc", function()
				builtin.find_files({ cwd = vim.env.DOTCONFIG_PATH })
			end, { desc = "[ ] [S]earch dot[C]onfig" })

			local telescope_process = require("plugins.telescope_process")
			vim.keymap.set("n", "<leader>sp", function(opts)
				print("HEEEE")
				telescope_process.list_processes(opts)
				print("FAIL")
			end, { desc = "[S]earch for current processes" })
